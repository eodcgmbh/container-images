# EODC GPU Notebook — Base (no DL framework)
...
#
# No deep learning framework is pre-installed. Install at runtime:
#   PyTorch:     pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu128
...
# JupyterHub overrides this CMD with jupyterhub-singleuser at spawn time.
# This default allows the image to also be run standalone.
CMD ["jupyter", "lab", \
     "--ip=0.0.0.0", \
     "--port=8888", \
     "--no-browser", \
